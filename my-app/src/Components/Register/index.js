    ...
    const formControl = [
        {
            ...
            placeholder: 'Prénom',
            value: form.name,
            setValue: (e) => updateForm(e, 'name'),
            errorHandling: (val) => {
                const trimValue = val.trim();
                if (trimValue.length < 2) 
                    return 'Vous devez renseigner votre prénom';
                return undefined;
            },
        },
        {
            ...
            errorHandling: (val) => {
                const trimValue = val.trim();
                if (trimValue.length < 2) 
                    return 'Vous devez reseigner votre nom';
                return undefined;
            },
        },
        {
    ...
    const classes = useStyles(theme);
        ...
        return (
            ...
            <ThemeProvider theme={muiTheme}>
                <FormControl variant="outlined" className={classes.formControl} border='white'>
                ...
                <FormControl variant="outlined" className={classes.formControl}>
                    <InputLabel id="demo-simple-select-outlined-label">Cherche</InputLabel>
                    <Select
                        labelId="demo-simple-select-outlined-label"
                        id="demo-simple-select-outlined"
                        value={form.target}
